...
namespace UnityEngine.XR.Interaction.Toolkit.Examples
{
    ...
    public class LocomotionSchemeManager : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip("Stores the \"RightRslt Hand\" Transform used with continuous movement when inputs should be relative to the right hand's orientation.")]
        Transform m_RightHandForwardSource;
        /// <summary>
        /// Stores the "RightRslt Hand" <see cref="Transform"/> used with continuous movement when inputs should be relative to the right hand's orientation.
        /// </summary>
